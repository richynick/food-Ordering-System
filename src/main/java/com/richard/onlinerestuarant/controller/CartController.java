...
import com.richard.onlinerestuarant.request.UpdateCartItemRequest;
import com.richard.onlinerestuarant.service.CartService;
...
public class CartController {
    ...
    @PutMapping("/cart/add")
    public ResponseEntity<CartItem> addCartItemToCart(@RequestBody AddCartItemRequest request, @RequestHeader("Authorization") String jwt) throws Exception {
