...
import com.richard.onlinerestuarant.repository.IngredientCategoryRepository;
import com.richard.onlinerestuarant.repository.IngredientItemRepository;
...
public class IngredientsServiceImpl implements IngredientsService{
    ...
    public IngredientsItem createIngredientItem(Long restaurantId, String ingredientName, Long categoryId) throws Exception {
        ...
        category.getIngredientsItemList().add(savedIngredient);
